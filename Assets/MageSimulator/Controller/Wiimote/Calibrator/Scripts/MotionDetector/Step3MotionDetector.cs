...
{
    public class Step3MotionDetector : MotionDetector
    {
        private static readonly Vector3 StayAccelValue = new Vector3(-1f, 0f, 0f);
        private const float MoveThreshold = 0.05f;
        private const float RotationThreshold = 0.8f;
